...
function myKeyDown(e)
{
	...
	function up()
	{
		if(ballY >=450)
		{
			...
			console.log("Quando a tecla direcional cima é pressionada, X = " + " , Y = "+ball_Y);
	...
	
	{
		if(ballY <=450)
		{
			...
			console.log("Quando a tecla direcional baixo é pressionada, X = " + " , Y = "+ball_Y);
			canvas.remove(ballObj);
			newImage();
		}
	...
	function left()
	{
		if(ballX >5)
		{
			...
			console.log ("Altura da imagem do bloco = " + block_image_height);
			console.log("Quando a tecla direcional esquerda é pressionada, X = " + " , Y = "+ball_X);
			canvas.remove(ballObj);
			newImage();
		}
	}
	...
	function right()
	{
		if(ballX <=1050)
		{
			ballX = ballX + blockImageHeight;
			console.log ("Altura da imagem do bloco = " + blockImageHeight);
			console.log("Quando a tecla direcional direita é pressionada, X = " + " , Y = "+ball_X);
			canvas.remove(ballObj);
			newImage();
		}
	}
